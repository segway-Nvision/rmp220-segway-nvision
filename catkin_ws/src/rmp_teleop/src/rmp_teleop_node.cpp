...
void RmpTeleop::Initialize()
{
  ...
  m_NodeHandle.param("joy_topic", joyMessageTopic, std::string("/rmp220/joy"));
  m_NodeHandle.param("velocity_command_topic", velocityCommandTopic, std::string("/rmp220/base/vel_cmd"));
  m_NodeHandle.param("deadman_topic", deadmanTopic, std::string("/rmp220/deadman"));
  m_NodeHandle.param("audio_command_topic", audioCommandTopic, std::string("/rmp220/audio_cmd"));
